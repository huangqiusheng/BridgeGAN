...
class RaFD_1608(Dataset):
    att_dict = {'angry': 0, 'contemptuous': 1, 'disgusted': 2,
                'fearful': 3, 'happy': 4, 'neutral': 5, 'sad': 6,
                'surprised': 7}
...
if __name__ == '__main__':
    ...
    data = Celeba('./data/CelebA', atts, 128, 32, part='train', is_tfrecord=False)
    # atts = ['Male','Young']
    # atts = ['angry', 'contemptuous', 'disgusted', 'fearful', 'happy', 'neutral', 'sad', 'surprised']
    #data = AFHQ('./data/afhq', 256, 32, part='train_dog', is_tfrecord=True, shuffle=False)#, filter_att = 5, filter_pos=1
